    ...
    var t = {
                        ...
                        backspace: function(e, o) {
                            if (!0 !== this.stop) {
                                ...
                                n.timeout = setTimeout((function() {
                                    ...
                                    var t = e.substr(0, o);
                                    n.attr ? n.el.attr(n.attr, t) : n.isInput ? n.el.val(t) : "html" === n.contentType ? n.el.html(t) : n.el.text(t), o > n.stopNum ? (o--, n.backspace(e, o)) : o <= n.stopNum && (n.arrayPos++, n.arrayPos === n.strings.length ? (n.arrayPos = 0, n.shuffle && (n.sequence = n.shuffleArray(n.sequence)), n.init("write")) : n.typewrite(n.strings[n.sequence[n.arrayPos]], o), n.options.highlightClass && s.is("." + n.options.highlightClass) && s.removeClass(n.options.highlightClass))
                                }), i)
                            }
                        },
            ...
            9268: function(t) {
                t.exports = {
                    ...
                    encode: function(t) {
                        let e, o, i, n, s, r, a, l = "",
                            c = 0;
                        for (t = this._utf8_encode(t); c < t.length;) e = t.charCodeAt(c++), o = t.charCodeAt(c++), i = t.charCodeAt(c++), n = e >> 2, s = (3 & e) << 4 | o >> 4, r = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? r = a = 64 : isNaN(i) && (a = 64), l = l + this._keyStr.charAt(n) + this._keyStr.charAt(s) + this._keyStr.charAt(r) + this._keyStr.charAt(a);
                        return l
                    },
                    decode: function(t) {
                        let e, o, i, n, s, r, a, l = "",
                            c = 0;
                        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); c < t.length;) n = this._keyStr.indexOf(t.charAt(c++)), s = this._keyStr.indexOf(t.charAt(c++)), r = this._keyStr.indexOf(t.charAt(c++)), a = this._keyStr.indexOf(t.charAt(c++)), e = n << 2 | s >> 4, o = (15 & s) << 4 | r >> 2, i = (3 & r) << 6 | a, l += String.fromCharCode(e), 64 != r && (l += String.fromCharCode(o)), 64 != a && (l += String.fromCharCode(i));
                    ...
                    _utf8_decode: function(t) {
                        let e = "",
                            ...
                            n = 0,
                            s = 0;
                        for (; o < t.length;) i = t.charCodeAt(o), i < 128 ? (e += String.fromCharCode(i), o++) : i > 191 && i < 224 ? (n = t.charCodeAt(o + 1), e += String.fromCharCode((31 & i) << 6 | 63 & n), o += 2) : (n = t.charCodeAt(o + 1), s = t.charCodeAt(o + 2), e += String.fromCharCode((15 & i) << 12 | (63 & n) << 6 | 63 & s), o += 3);
                        return e
                    }
                }
            },
            ...
            19761: function(t) {
                ...
                e = ThriveGlobal.$j, TCB_Front, t.exports = function() {
                    ...
                    "undefined" != typeof ResizeObserver ? new ResizeObserver((() => {
                        s()
                    })).observe(window.document.body) : s()
                }
            },
            45889: function(t) {
                ! function(e, o) {
                    ...
                    function h(t) {
                        if (function() {
                            ...
                            let i = "";
                            t >= r ? (l.css(e), a.css(o), i = a.outerHeight()) : (a.css(e), l.css(o), d.data("cloneSticky") && d.data("cloneSticky")[0].style.setProperty("height", `${l.outerHeight()}px`)), d[0] && d[0].style.setProperty("height", i ? `${i}px` : "")
                        }
                    }
                ...
                t.exports = t => new class {
                    ...
                    doAction(e) {
                        if (this.CURRENT_ACTIONS = this.CURRENT_ACTIONS || [], this.hasAction(e)) {
                            ...
                            this.CURRENT_ACTIONS.push(e), t.each(i, (function(t, e) {
            ...
            85913: function() {
                ...
                t = ThriveGlobal.$j, (e = TCB_Front).$document.on("click", "a.tve-jump-scroll", (function(o) {
                    ...
                    n.length && n.find(o).length && (d = n), e.$body.off("tcb-sticky-remove tcb-sticky-add tcb-sticky-scroll-down").on("tcb-sticky-add", (function(t, e) {
            ...
            81556: function(t) {
                ...
                e = ThriveGlobal.$j, t.exports = function(t, o) {
                    ...
                    function l(t, o) {
                        TCB_Front.$window.trigger("tve_after_content_toggle", [t, !1]), e(window).trigger("tcb_before_lightbox_close", t), void 0 === o && 1 === e(".tve_lb_open").length && (i.removeClass(s).css("padding-right", ""), n.removeClass(s), t.data("doc-scroll-top") ? (document.documentElement.scrollTop = t.data("doc-scroll-top"), t.data("doc-scroll-top", "")) : t.data("bdy-scroll-top") && (document.body.scrollTop = t.data("bdy-scroll-top"), t.data("doc-scroll-top", ""))), t.removeClass("tve_lb_open tve_lb_opening").addClass("tve_lb_closing"), setTimeout((function() {
                    ...
                    function c(o) {
                        let i, n, s = t.find(".tve_p_lb_content"),
                            r = TCB_Front.$window.height(),
                            a = void 0 !== o && o ? "animate" : "css";
                        e(window).trigger("tcb_before_lightbox_reposition"), i = s.outerHeight(!0), n = (r - i) / 2, t.find(".tve_p_lb_overlay")[a]({
                            height: i + 80 + "px",
                            "min-height": r + "px"
                        }, 200), s[a]({
                            top: (n < 40 ? 40 : n) + "px"
                        }, 200), i + 40 > r && t.addClass("tve-scroll")
                    }
                    if (t.off().on("click", ".tve_p_lb_close", (function() {
                            ...
                            return l(t), !1
                        })), l(e(".tve_p_lb_background.tve_lb_open"), !0), t.data("doc-scroll-top", document.documentElement.scrollTop), t.data("bdy-scroll-top", document.body.scrollTop), i.addClass(s), n.addClass(s), TCB_Front.$window.height() < TCB_Front.$document.height() && i.css("padding-right", a + r + "px"), t.find(".tve_scT").length ? TCB_Front.Utils.isEditorPage() || t.find(".tve_scT").each((function() {
                            let t = e(this),
                        ...
                        })) : TCB_Front.$window.trigger("tve_after_content_toggle", [t]), setTimeout((function() {
                            t.css("display", ""), t.addClass("tve_lb_opening"), setTimeout((function() {
                                t.addClass("tve_p_lb_background tve_lb_anim_" + o), c()
                            }), 0)
                        }), 20), t.find(".tve_p_lb_content").trigger("tve.before-lightbox-open"), "none" === t.css("display") || t.hasClass("tve_lb_closing") ? (t.removeClass("tve_lb_open"), i.removeClass(s).css("padding-right", ""), n.removeClass(s)) : setTimeout((function() {
            ...
            776: function(t) {
                ...
                e = ThriveGlobal.$j, o = TCB_Front, t.exports = class {
                    ...
                    toggleCustomNotification(t, o, i) {
                        ...
                        t && r.length > 0 && r.empty().append(t), o && this.$notificationWrapper.attr("data-state", o), this.$notificationWrapper.removeAttr("data-animation"), setTimeout((() => {
            ...
            43959: function(t) {
                ...
                e = ThriveGlobal.$j, o = TCB_Front, t.exports = {
                    ...
                    convertDate: function(t) {
                        ...
                        const s = e.getDate();
                        t = (t = (t = (t = t.replace(/(^|[^\\])dddd+/g, "$1" + ["", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][s])).replace(/(^|[^\\])ddd/g, "$1" + ["", "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][s])).replace(/(^|[^\\])dd/g, "$1" + o(s))).replace(/(^|[^\\])d/g, "$1" + s);
                        const r = e.getHours(),
            ...
            97447: function(t) {
                ...
                function i(t, e, o) {
                    ...
                    function k(t, e, o) {
                        g = o, u.each((function() {
                            if (B(this), ! function() {
                                ...
                                }() || b || !a.hasClass(`tve-sticky-${l.end}-hidden`) && !a.is(":visible")) return b && a.removeData("clone-sticky"), _.on_scroll_up_default(t, !0), "parallax" === l.mode && x(a, b), void a.removeClass(`tve-scroll-${l.mode}`);
                    ...
                    _.on_scroll_down_default = function(t, o) {
                        ...
                        if (u && i.$body.trigger("tcb-sticky-initialized", a), "bottom" === l.stickyPosition && (u = t + window.innerHeight > p.top + a.height() + Number(a.data("defaultTop")), f = !1, i.isBottomScroll(t) ? S(!0, "default") : d && l.top !== a.data("previousTop") && (a[0].style.setProperty("top", `${l.top}px`), a.data("previousTop", l.top))), d) return "appear" === l.mode && r(a, o), void(f && i.$body.trigger("tcb-sticky-add", [a]));
                        if (u) {
                            ! function() {
                            ...
                            a[0].style.setProperty("margin-top", "0px", "important"), a[0].style.setProperty("margin-left", g, "important"), a[0].style.setProperty("min-width", "0", "important"), a[0].style.setProperty("max-width", "none", "important"), a[0].style.setProperty("position", s, "important"), a[0].style.setProperty("box-sizing", "content-box", "important");
                        ...
                        if (_.on_scroll_up_default(t), d) {
                            const e = C(t);
                            "bottom" === l.stickyPosition && a.hasClass("tve-sticky-parent-hidden") && (a.data("hideTop") !== e ? (S(!1, "parent"), a.data("prevTop", 0), a.data("hideTop", 0)) : a[0].style.setProperty("display", "none", "important")), a.css("top", e)
                        }
                        ...
                        t && "bottom" === l.stickyPosition && o && o === e && S(!0, "element"), d ? (a.css("top", n.top), "bottom" !== l.stickyPosition && i.$body.trigger("tcb-sticky-add", [a])) : _.on_scroll_down_default(t, n)
                    }, _.on_scroll_up_element = function(t) {
                        if (_.on_scroll_up_default(t), d) {
                            const e = Math.min(l.top, a.data("$$stop-offset").top - t - a.outerHeight());
                            a.css("top", e), "bottom" === l.stickyPosition ? a.hasClass("tve-sticky-element-hidden") && e === l.top && S(!1, "element") : i.$body.trigger("tcb-sticky-add", [a])
                        }
                            ...
                            if (r > e.start) {
                                ...
                                switch (t) {
                                    ...
                                    case "transparency":
                                        ...
                                        break;
                                    case "3dperspective":
                                        e.perspective = Number(e.perspective), "from" === e.direction ? o = (1e3 - e.perspective) * (n - e.start) / 100 * e.speed + e.perspective : (n = 100 - n, o = Math.max(e.perspective, e.perspective * n / 100 * e.speed)), o = Math.max(o, 100), i.inlineCssVariable(a, "--parallaxRY") !== `${e.degrees}deg` && s.push({
                                            key: "RY",
                                            value: `${e.degrees}deg`
                                        })
                                }
                    ...
                    const F = s((function() {
                        u.each((function() {
                            B(this), _.on_scroll_up_default(0, !0);
                    ...
                    m.initSticky = function() {
                        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : i.$body,
                            e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        f = e, $(t), u.length && (x(), f || (i.$body[0].style.overflowX = "hidden")), i.add_scroll_callback(k), i.addResizeCallback(F), i.$body.length && (v = i.inlineCssVariable(i.$body, "--off-screen-sidebar-size")), y = i.$body.attr("data-off-screen-type"), w = i.$body.attr("data-off-screen-side")
                    ...
                    class i {
                        ...
                        static unserialize(t) {
                            ...
                            return function t(e, o) {
                                let r, a, l, c, d, h, p, f, u, g, _, m, b, v, y, w, T, C, $ = 0,
                                    k = function(t) {
                                        return t
                                    };
                                switch (o || (o = 0), r = e.slice(o, o + 1).toLowerCase(), a = o + 2, r) {
                                    ...
                                    case "n":
                                        ...
                                        break;
                                    case "s":
                                        g = s(e, a, ":"), $ = g[0], _ = g[1], a += $ + 2, u = function(t, e, o) {
                                            let n, s, r = [];
                                        ...
                                        break;
                                    case "a":
                                        for (f = {}, l = s(e, a, ":"), $ = l[0], c = l[1], a += $ + 2, h = parseInt(c, 10), d = !0, m = 0; m < h; m++) v = t(e, a), y = v[1], b = v[2], a += y, w = t(e, a), T = w[1], C = w[2], a += T, b !== m && (d = !1), f[b] = C;
                                        if (d) {
        ...
        function() {
            ...
            window.TCB_Front = window.TCB_Front || {}, TCB_Front.Hooks = o(20325)(ThriveGlobal.$j), window.addEventListener("load", (function() {
                ...
                detectBrowser() {
                    ...
                    return t.msie && (t.version = e), t.ios = ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].includes(navigator.platform) || navigator.userAgent.includes("Mac") && "ontouchend" in document, t
                },
                getCookie(t) {
                    const e = `${t}=`;
                ...
                handleIframes() {
                    ...
                    t.find(s.join(", ")).not(".thrv_social_default iframe").each((function() {
                ...
                onDOMReady(t) {
                    if (this.$body = ThriveGlobal.$j("body"), this.body_offset = this.$body.offset(), void 0 === t && (t = this.$body), this.notificationElement = new this.notification, TCB_Front.$window.on("tve_after_content_toggle", (function(t, e) {
                        ...
                        })), this.smartComplete.init(t), tve_frontend_options.is_editor_page || (this.add_scroll_callback(this.showDataElements, this), this.header(t), this.sticky.initSticky(t, !!tve_frontend_options.is_editor_page)), this.fix_compat_issues(t), this.replaceDynamicContent(), tve_frontend_options.is_editor_page || ("undefined" != typeof ResizeObserver ? new ResizeObserver((() => TCB_Front.resizePageSection())).observe(document.body) : TCB_Front.addResizeCallback(TCB_Front.resizePageSection)), tve_frontend_options.is_editor_page) try {
                        ...
                        window.tcb_autofill && ThriveGlobal.$j.isArray(window.tcb_autofill) && (ThriveGlobal.$j.each(window.tcb_autofill, (function(e, o) {
                            ...
                            }), o ? (s < 30 ? (r = "#ef5350", a = "Weak", n = i.find(".tve-password-strength:lt(1)")) : s >= 30 && s < 60 ? (r = "#ffa726", a = "So-so", n = i.find(".tve-password-strength:lt(2)")) : s >= 60 && s < 80 ? (r = "#8bc34a", a = "Good", n = i.find(".tve-password-strength:lt(3)")) : (r = "#4caf50", a = "Great!", n = i.find(".tve-password-strength:lt(4)")), n.each((function() {
                                ThriveGlobal.$j(this).css({
                                    "background-color": r
                                })
                            })), i.attr("data-score", s).find(".tve-password-strength-text").text(a).css({
                                color: r
                ...
                resizePageSection(t) {
                    ...
                    e && ("left" === TCB_Front.$body.attr("data-off-screen-side") ? (i = parseInt(TCB_Front.$body.css("padding-left")), o -= i) : o -= parseInt(TCB_Front.$body.css("padding-right"))), o += "px", t.each(((t, e) => {
                        ...
                        let s = n.css("left");
                        s = "auto" === s ? 0 : Number(n.css("left").replace("px", "")), s = s + i - n.offset().left, n.css({
                            width: o,
                            left: s + "px"
                        })
                    }))
